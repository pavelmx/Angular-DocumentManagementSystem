...
export class CreditEditComponent implements OnInit {
  ...
  saveAsPDF() {
    ...
    if (this.curUser.adress == null || this.curUser.adress == '') {
      ...
      this.pdfService.saveAsPDFCredit(this.form.title, this.form.clientFullName, this.form.clientAdress,
        this.curUser.name, this.curUser.adress, this.form.dateOfCreation, this.form.otherInfo,
        this.form.creditAmount, this.form.annualInterest, this.form.term);
